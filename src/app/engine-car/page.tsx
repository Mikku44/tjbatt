    ...
    <div className=''>
      ...
      >
        ...
        <div className='h-full max-w-[90%] md:max-w-[50%] md:m-0 m-auto py-10 flex flex-col justify-end md:justify-between relative z-10'>
          ...
          >
            เราให้บริการเปลี่ยนแบตเตอรี่สำหรับรถสันดาป
          </motion.h1>
      ...
      <main className='min-h-screen max-w-7xl m-auto md:mt-20 mt-5 px-4 mb-10'>
        ...
        <p className='mt-4 leading-8 text-gray-700 mb-12 text-lg px-4'>
          <b>รถยนต์สันดาป (ICE)</b>{' '}
          คือรถที่ขับเคลื่อนด้วยเครื่องยนต์เบนซินหรือดีเซล
          ซึ่งอาจมีการปล่อยไอเสียและมีระบบเครื่องยนต์และอุปกรณ์เสริมที่ซับซ้อน
          เช่น ระบบน้ำหล่อเย็น, ระบบหัวฉีด, ระบบจุดระเบิด, ระบบเบรก ABS,
          และแบตเตอรี่ 12 Volt ที่ต้องการการดูแลและบำรุงรักษาตามระยะเวลา
          <br />
          ดังนั้น การซ่อมบำรุงเครื่องยนต์
          หรือการเปลี่ยนอะไหล่ที่เกี่ยวข้องกับระบบไฟฟ้า
          และระบบเครื่องยนต์ของรถสันดาป จึงจำเป็นต้องอาศัยผู้เชี่ยวชาญ
          และอุปกรณ์มาตรฐาน
        ...
        <section className='my-10 space-y-8'>
          {[
            {
              path: '/raw/images-tj/enginecar (indx).jpg',
              count: 24,
              alt: 'เปลี่ยนแบตเตอรี่ รถยนต์สันดาป'
            }
          ].map(image => (
