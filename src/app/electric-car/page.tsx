    ...
    <div className=''>
      ...
      <main className='min-h-screen max-w-7xl m-auto md:mt-20 mt-5 px-4 mb-10'>
        ...
        <p className='mt-4 leading-8 text-gray-700 mb-12 text-lg px-4'>
          ...
          และมีระบบเทคโนโลยีล้ำสมัย ไม่ว่าจะเป็น Tesla, BMW i Series, Mercedes
          EQ, BYD หรือ Volvo Recharge
          รถไฟฟ้ามีระบบไฟฟ้าแรงดันสูงและแบตเตอรี่ลิเธียมที่ต้องการการดูแลเฉพาะทาง
          <br />
