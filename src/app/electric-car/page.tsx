...
export const metadata: Metadata = {
  ...
  description:
    'รวมข้อมูลและบริการเกี่ยวกับแบตเตอรี่รถยนต์ไฟฟ้า (EV) จาก ตั้งใจขายแบต พร้อมบริการเปลี่ยนและติดตั้งถึงที่ ดูแลครบวงจร ครอบคลุมหลายพื้นที่ บริการรวดเร็ว ราคาคุ้มค่า',
    ...
    <div className=''>
      ...
      >
        ...
        <div className='h-full max-w-[90%] md:max-w-[50%] md:m-0 m-auto py-10 flex flex-col justify-end md:justify-between relative z-10'>
          ...
          >
            ติดตั้งแบตเตอรี่รถยนต์ไฟฟ้า พื้นที่ให้บริการกรุงเทพฯ
